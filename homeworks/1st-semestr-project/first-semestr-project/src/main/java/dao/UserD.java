...
public class UserD {
    ...
    private static final String insert_sql = "insert into users (email, username, password) values (?, ?, MD5(?)";


    private static final String validate_sql = "select * from users where email = ? and password = MD5(?)";
